...
import io.rss.openapiboard.server.services.RequestSampleHandler
...
class RequestSampleResource {
    ...
    fun createRequest(@ApiParam request: SampleRequestResponse): Response {
    ...
    fun saveRequest(@PathParam("id") id: Long, @ApiParam request: SampleRequestResponse): SampleRequestResponse {
