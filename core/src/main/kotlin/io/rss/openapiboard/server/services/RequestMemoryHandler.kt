...
class RequestMemoryHandler (
    ...
    private fun updateRequest(existingMemory: RequestMemory, inputRequest: RequestMemoryRequestResponse): RequestMemory {
        with(existingMemory) {
    ...
    private fun processParameters(sourceRequest: RequestMemoryRequestResponse, target: RequestMemory) {
    ...
    fun search(query: String?, offset: Int): QueryResult<List<RequestMemoryRequestResponse>> {
